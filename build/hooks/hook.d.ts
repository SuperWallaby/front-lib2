...
export declare const useImgsManager: (localImgKey: string, defaultUrls: string[], option?: IuseImageUploaderOption) => IUseImgsManager;
...
declare function useSelect<V = any>(defaultValue: IselectedOption<V> | null): IUseSelect<V>;
