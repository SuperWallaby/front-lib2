...
export declare const InputText: React.ForwardRefExoticComponent<IInputTextCutsomProp &
  React.AllHTMLAttributes<HTMLInputElement> &
  React.RefAttributes<HTMLInputElement>>;
declare const MemoInput: React.MemoExoticComponent<React.ForwardRefExoticComponent<
