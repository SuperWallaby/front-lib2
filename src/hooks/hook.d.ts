...
declare const useStoreSelect: (stores: {
    [key: string]: any;
...
declare const useFilesManager: (defaultUrls?: string[] | undefined, localFileKey?: string | undefined, imgOption?: IuseImageUploaderOption) => IuseFilesManager;
...
declare function useInput<T = string>(defaultValue: T, defulatValid?: boolean | string, prefix?: any, suffix?: any): TUseInput<T>;
...
declare function useRange(defaultValue: number, maxValue?: number, minValue?: number): {
    value: number;
...
declare function usePageNation(defaultValue: number): IusePageNation;
...
declare const _default: {
    ...
    useFilesManager: (defaultUrls?: string[] | undefined, localFileKey?: string | undefined, imgOption?: IuseImageUploaderOption) => IuseFilesManager;
    useWindowSize: typeof useWindowSize;
};
export default _default;
export { useInput, useCheckBox, useRadio, useSwitch, useSelect, useToggle, useModal, useSideNav, useRange, useDebounce, useStoreSelect, useShouldSave, useDayPicker, usePageNation, useFilesManager, useRedirect, useCheckBoxTable, useWindowSize, };
